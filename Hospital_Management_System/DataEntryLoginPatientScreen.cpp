...
Data_Entry_Login_Patient_Screen::Data_Entry_Login_Patient_Screen(int w_width, int w_height) : Screen(ScreenId::dataentry_login_patient, w_width, w_height) {
	add_entity(std::make_shared<Button>(std::string("Back"), 30u, OutlineThickness, sf::Vector2f(150.0f, 80.0f), sf::Vector2f(100.0f, 110.0f), sf::Color::Black, lightRed, sf::Color::Black, ScreenId::dataentry_login));
