...
Push_Test_Results_Screen::Push_Test_Results_Screen(int w_width, int w_height) : Screen(ScreenId::push_test_results, w_width, w_height) {
	...
	add_entity(std::make_shared<TextBox>(std::string(""), 30u, OutlineThickness, sf::Vector2f(400.0f, 60.0f), sf::Vector2f(520.0f, 420.0f), sf::Color::Black, lightBlue, sf::Color::Black));
	add_entity(std::make_shared<TextBox>(std::string(""), 30u, OutlineThickness, sf::Vector2f(400.0f, 60.0f), sf::Vector2f(1280.0f, 420.0f), sf::Color::Black, lightBlue, sf::Color::Black));
	...
	add_entity(std::make_shared<TextBox>(std::string(""), 30u, OutlineThickness, sf::Vector2f(1160.0f, 60.0f), sf::Vector2f(520.0f, 620.0f), sf::Color::Black, lightBlue, sf::Color::Black));
	...
	add_entity(std::make_shared<Button>(std::string("Push"), 30u, OutlineThickness, sf::Vector2f(200.0f, 80.0f), sf::Vector2f(get_center_coord(LEFT_MARGIN, (w_width - 2 * LEFT_MARGIN) * 1.0f, 200.0f), 920.0f), sf::Color::Black, lightYellow, sf::Color::Black, ScreenId::dataentry_login_patient, FuncType::_default));

	add_entity(std::make_shared<ImageBox>(std::string("./Images/dataEntry.png"), sf::Vector2f(get_center_coord(LEFT_MARGIN, (w_width - 2 * LEFT_MARGIN) * 1.0f, 1400.0f) + 1450.0f, 100.0f), sf::Vector2f(0.3f, 0.3f)));
}
