...
Pending_Tests_Screen::Pending_Tests_Screen(int w_width, int w_height) : Screen(ScreenId::pending_tests, w_width, w_height) {
...
void Pending_Tests_Screen::fill_form(std::vector<std::string>& data) {
	...
	for (int i = 0; i < dsize; i++) {
		...
		add_entity(std::make_shared<TextBox>(std::string("Date : ") + data[i++], 30u, 0.0f, sf::Vector2f(334.0f, 65.0f), sf::Vector2f(xcoord + 7, ycoord + 75), sf::Color::Black, lightBlueConst, bgWhite));
