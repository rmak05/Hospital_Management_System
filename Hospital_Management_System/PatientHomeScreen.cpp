...
Patient_Home_Screen::Patient_Home_Screen(int w_width, int w_height) : Screen(ScreenId::patient_home, w_width, w_height) {
	...
	add_entity(std::make_shared<Button>(std::string("Appointment"),			30u, OutlineThickness, sf::Vector2f(600.0f, 80.0f), sf::Vector2f(1200.0f, 540.0f), sf::Color::Black, lightYellow, sf::Color::Black, ScreenId::_default));
